package com.jameshaltiwanger.languages.controller;
...
import com.jameshaltiwanger.languages.services.LanguagesService;

@Controller
public class LanguagesController {
	
	//Dependency Injecting LanguagesServic to have access to its methods!
